...
export const TOOLS = [
  ...
  },
  {
    ...
    description:
      ...
      '⚠️ ЗӨВХӨН хэрэглэгч ӨӨРӨӨ хэлсэн үед дуудна — өмнөх боловсрол, ' +
      'насыг нь АСУУХ ЁСГҮЙ. Юу ч хэлээгүй бол энэ хэрэгслийг огт дуудахгүй, ' +
      'standard гэж үзнэ.',
    strict: true,
    input_schema: {
      type: 'object',
...
export async function executeTool(call, ctx) {
  ...
  try {
      ...
      return {
        content: sent
          ? [
              ...
              'бичээстэй байгаа тул ТЕКСТЭЭР ДАХИН БҮҮ ЖАГСАА.',
              '⚠️ Хэрэглэгчийн асуултад ХАРААХАН ХАРИУЛААГҮЙ бол ЭХЛЭЭД түүнд',
              'хариул — картыг илгээсэн нь асуултыг нь орлохгүй.',
              'Дараа нь ЯГ энэ өгүүлбэрийг бич:',
              '"Сонгосон мэргэжлийнхээ дугаарыг бичээрэй 😊"',
            ].join(' ')
          : [
              'Карт илгээж чадсангүй.',
              'Хэрэглэгчийн асуултад хараахан хариулаагүй бол ЭХЛЭЭД түүнд хариул.',
              'Дараа нь мэргэжлүүдийг дугаарын хамт товч жагсаагаад',
              '"Сонгосон мэргэжлийнхээ дугаарыг бичээрэй 😊" гэж хэл.',
            ].join(' '),
      };
    }
        ...
        content:
          ...
          (imageSent
            ? ' ТАНИЛЦУУЛГА КАРТ ИЛГЭЭГДЛЭЭ. Картан дээр хөтөлбөрийн нэр, гарчиг,'
              ...
              + ' ТЕКСТЭЭР ДАХИН БҮҮ БИЧ — давхардал болно.'
              + ' ⛔ Өмнөх боловсрол, насыг нь БҮҮ АСУУ. Шууд 5-р алхам руу ор:'
              + ' тэр нь ЯГ ЯМАР МЭРГЭЖИЛТЭН болж, хаана ажиллахыг тодорхой хэл.'
            : ' Хөтөлбөрийн талаар 2-3 өгүүлбэрээр товч танилцуулаад, тэр нь ЯГ ЯМАР'
              + ' МЭРГЭЖИЛТЭН болохыг хэл. Өмнөх боловсрол, насыг нь БҮҮ АСУУ.'),
      };
    }
    ...
    if (name === 'set_applicant_track') {
      ...
      return {
        content: [
          ...
          'Эхний жилийн сургалтын төлбөр ҮНЭГҮЙ. Зуны ажлын боломжийг ӨӨРӨӨ бүү дурд.',
    ...
    if (name === 'save_contact_info') {
      ...
      // Онлайн замд gmail ШААРДАХГҮЙ — гэрээг вэбсайт дээр хийдэг тул
      // и-мэйлээр юу ч илгээхгүй. Нэр, утас хангалттай.
      const complete = Boolean(lead.name && lead.phone && (online || lead.visit));
        ...
        return {
          content: online
            ? [
                ...
                'Одоо яриаг дуусга. Цахим бүртгэлийн хаягийг ДАВТАЖ хэл:',
                REGISTER_URL,
                'Хаягийг яг хэвээр нь бич.',
                'Суудал баталгаажуулалт ' + formatMnt(TUITION.seatDeposit) + ' гэдгийг сануулаад,',
                '"Данс авах бол хэлээрэй" гэж нэм.',
                '⛔ Дансны дугаарыг АСУУГААГҮЙ бол БҮҮ БИЧ.',
                '⛔ Гэрээ илгээх тухай БҮҮ ХЭЛ.',
      ...
      return {
        content: online
          ? 'Бүртгэлээ. Дутуу мэдээллийг НЭГ НЭГЭЭР нь асуу (нэр → утас). Gmail ШААРДЛАГАГҮЙ.'
      ...
      if (mode.id === 'online') {
        return {
          content: [
            ...
            'Хэрэглэгчид дараахыг НЭГ мессежээр хэлээд яриаг ДУУСГА:',
            '1) Цахим бүртгэлээ энэ хаягаар хийнэ — ' + REGISTER_URL,
            'Хаягийг ЯГ ХЭВЭЭР нь бич, богиносгож эсвэл өөрчилж БОЛОХГҮЙ.',
            '2) Суудал баталгаажуулалт нь ' + formatMnt(TUITION.seatDeposit) + ' гэдгийг хэл.',
            '3) "Данс авах бол хэлээрэй" гэж НЭМ.',
            '4) Төгсгөлд нь ирээдүйнхээ төлөө шийдвэр гаргасанд нь ДУЛААХАН',
            'баяр хүрг — emoji хэрэглэ.',
            '⛔ НЭР, УТАС, GMAIL АСУУХГҮЙ — бүртгэлийг вэбсайт дээр хийнэ,',
            'мэдээллийг нь тэндээс авна. Дахин асуувал хүн уйдна.',
            '⛔ Дансны дугаарыг АСУУГААГҮЙ бол БҮҮ БИЧ.',
            '⛔ Гэрээ илгээх тухай БҮҮ ХЭЛ.',
          ].join(' '),
        };
