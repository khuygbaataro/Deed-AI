      ...
      if (mode.id === 'online') {
        return {
          content: [
            ...
            '3) Дараа нь "Данс авах бол хэлээрэй" гэж НЭМ.',
            '⛔ ДАНСНЫ ДУГААРЫГ ОДОО БҮҮ БИЧ. Хэрэглэгч данс АСУУСАН үед л өгнө.',
            '⛔ Гэрээ илгээх тухай БҮҮ ХЭЛ — гэрээг вэбсайт дээр бүртгүүлэх үед хийнэ.',
            'Дараа нь НЭГ асуулт: нэрийг нь асуу. Утсыг тусад нь дараа нь ав.',
          ].join(' '),
        };
      }
